...
import { EmberAddonPackage, getExternalModuleMappings, getInternalModuleMappings } from '../index';
import {
...
describe('Smoke Test', () => {
  describe('getInternalModuleMappings', () => {
    ...
    test('it works correctly for addons that specify a custom `moduleName`', () => {
      ...
      const customAddonName = mappingsByAddonName[
        FIXTURE_NAMES.ADDON_WITH_MODULE_NAME
      ] as EmberAddonPackage;

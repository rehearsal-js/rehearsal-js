...
// @ts-expect-error ts-migrate(6133) FIXED: 'msToSeconds' is declared but its value is never r... Remove this comment to see the full error message
function msToSeconds(ms: number): number {
  return Math.round(ms / 1000);
}

// @ts-expect-error ts-migrate(6133) FIXED: 'readJSON' is declared but its value is never read... Remove this comment to see the full error message
...
// @ts-expect-error ts-migrate(6133) FIXED: 'timestamp' is declared but its value is never rea... Remove this comment to see the full error message
function timestamp(inSeconds = false): number {
  return inSeconds ? Date.now() / 1000 : Date.now();
}

// @ts-expect-error ts-migrate(6133) FIXED: 'parseLongDescribe' is declared but its value is n... Remove this comment to see the full error message
...
// @ts-expect-error ts-migrate(6133) FIXED: 'normalizeVersionString' is declared but its value... Remove this comment to see the full error message

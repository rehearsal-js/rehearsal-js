/**
 *  Typescript doesn't provide a functionality to get the lists below.
 *  You can find hints on how to get those lists in comments.
 */

/*
  The simplest way to get all fixNames is to walk through TypeScript source code codefix files:
...
/*
  To update the list below, you need to modify getSupportedErrorCodes function in typescript.js to:

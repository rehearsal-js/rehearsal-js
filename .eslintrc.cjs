...
module.exports = {
  ...
  overrides: [
    {
      files: ['./packages/codefixes/**/*.ts', './packages/migrate/**/*.ts', './packages/migration-graph/**/*.ts', './packages/migration-graph-ember/**/*.ts', './packages/migration-graph-shared/**/*.ts', './packages/plugins/**/*.ts'],
